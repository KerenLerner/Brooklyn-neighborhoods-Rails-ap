...
class NeighborhoodsControllerTest < ActionController::TestCase
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post :create, neighborhood: { activities: @neighborhood.activities, architecture: @neighborhood.architecture, commute: @neighborhood.commute, name: @neighborhood.name, park: @neighborhood.park, rent: @neighborhood.rent }
    end
  ...
  test "should update neighborhood" do
    patch :update, id: @neighborhood, neighborhood: { activities: @neighborhood.activities, architecture: @neighborhood.architecture, commute: @neighborhood.commute, name: @neighborhood.name, park: @neighborhood.park, rent: @neighborhood.rent }
    assert_redirected_to neighborhood_path(assigns(:neighborhood))
  end
